...
class Person(object):
    ...
    __init__(self, _id, is_vaccinated, infection=None):
        - self.alive should be automatically set to true during instantiation. [x]
        - all other attributes for self should be set to their corresponding parameter
            passed during instantiation. [x]
        - If person is chosen to be infected for first round of simulation, then
            ...
            self.infection.  Otherwise, self.infection should be set to None. [x]
    did_survive_infection(self):
        - Only called if infection attribute is not None. [x]
        - Takes no inputs. [x]
    ...
    def did_survive_infection(self):
        # TODO:  Finish this method. Follow the instructions in the class documentation
        # TODO: You will need to decix`de what parameters you pass into this method based on how you structure your class.
